			...
			<div class="card">
				<div class="card-body">
					<div class="card-list">
						...
						<a href="modul/rekap/rekap_bulan.php?pelajaran=<?= $_GET['pelajaran'] ?>&bulan=<?= $bulan - 2; ?>" class="btn btn-warning btn-block text-left" target="_blank"><i class=" fas fa-file-alt"></i> BULAN SEBELUMYA</a>
					</div>
					<?php
