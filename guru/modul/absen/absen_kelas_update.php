...
<div class="page-inner">
    ...
    <div class="row">
        <div class="col-md-8 col-xs-12">
            <?php
            // tampilkan jika ada yg izin hari ini
            // tampilkan statuss izin
            $today = date('Y-m-d'); // tanggal sekarang
            $queryIzin = mysqli_query($con, "SELECT * FROM tb_siswa WHERE  tb_siswa.id_mkelas=" . $d['id_mkelas']);
            ...
            <div class="card">
                ...
                <center>
                    ...
                    <button type="submit" name="update" class="btn btn-success"><i class="fa fa-check"></i> Update Absensi</button>
