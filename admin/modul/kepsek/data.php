              ...
              <tbody>
                ...
                foreach ($kepsek as $k) { ?>
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-info btn-sm" href="?page=kepsek&act=edit&id=<?= $k['id_kepsek'] ?>"><i class="far fa-edit"> Edit</i></a>
                      <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ID <?= $k['id_kepsek'] ?> ??')" href="?page=kepsek&act=del&id=<?= $k['id_kepsek'] ?>"><i class="fas fa-trash"> Del</i></a>
                      <a class="btn btn-warning btn-sm" href="?page=kepsek&act=detail&id=<?= $k['id_kepsek'] ?>">Details</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
