                            ...
                            foreach ($kelas as $k) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Data ID <?= $k['id_walikelas'] ?> ??')" href="?page=wakel&act=delwakel&id=<?= $k['id_walikelas'] ?>"><i class="fas fa-trash"></i> Del</a>
                ...
                <form action="" method="post" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <select name="wakel" class="form-control">
                            ...
                            <?php
                            $wakel = mysqli_query($con, "SELECT * FROM tb_guru");
                            foreach ($wakel as $wk) {
