...
// Periksa parameter GET
if (!isset($_GET['kelas']) || empty($_GET['kelas'])) {
	die("Parameter kelas tidak ditemukan.");
}
...
$kelas = mysqli_query($con, "SELECT * FROM tb_mkelas WHERE id_mkelas='$_GET[kelas]'");
...
<div class="page-header">
	...
	<ul class="breadcrumbs">
		...
		<li class="nav-item">
			<a href="#">KELAS (<?= $kelasData['nama_kelas']; ?>)</a>
		</li>
	</ul>
</div>
			...
			<div class="card-body">
				<table class="table table-head-bg-danger table-xs">
					...
					<tbody>
						<?php
						$no = 1;
						mysqli_data_seek($kelasMengajar, 0); // Reset pointer
