...
<head>
	...
	<link rel="icon" href="../assets/img/iibs.jpg" type="image/x-icon" />
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					...
					<b class="text-white">IIBS AL BAROKAH</b>
				</a>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="siswa">
								<ul class="nav nav-collapse">
									<li><a href="?page=siswa&act=add "><span class="sub-item"> Tambah Siswa </span></a></li>
									<li>
										<a href="?page=siswa"> <span class="sub-item"> Daftar Siswa </span></a>
									</li>
									<li>
										<a href="?page=siswa&act=logabsen"> <span class="sub-item"> Log Absen </span></a>
									</li>
								</ul>
							</div>
						</li>
			...
			<div class="content">
				...
				if ($page == 'master') {
					...
					if ($act == '') {
						...
						include 'modul/kepsek/detail.php';
					} elseif ($act == 'proses') {
					...
					if ($act == '') {
						...
						include 'modul/siswa/logabsen.php';
					}
				} elseif ($page == 'rekap') {
					if ($act == '') {
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="" method="post" enctype="multipart/form-data">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								<button name="addadm" type="submit" class="btn btn-primary">Add Administrator</button>
							</div>
						</form>
						<?php
						if (isset($_POST['addadm'])) {
							...
							if (!empty($gambar)) {
								move_uploaded_file($_FILES['foto']['tmp_name'], "../assets/img/user/$gambar");
								$ganti = mysqli_query($con, "INSERT INTO tb_admin VALUE foto='$gambar' WHERE id_admin='$_POST[id]' ");
							}

							$sqlAdd = mysqli_query($con, "INSERT INTO tb_admin VALUE (NULL,'id_admin$_POST[id]',nama_lengkap='$_POST[nama]',username='$_POST[username]',$pass,Y,$gambar)");
			...
			<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y'); ?> Absensi IIBS AL BAROKAH (<a href="index.php">USM-Informatika 05 - Kel.3 </a> | 2024)
					</div>
				</div>
			</footer>
		</div>
